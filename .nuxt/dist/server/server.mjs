...
const _routes = [
  {
    name: "chan",
    path: "/chan",
    component: () => import("./nuxt_assets/chan-BB4fFrtp.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./nuxt_assets/index-eQ68a3ca.js")
  },
  {
    name: "wu",
    path: "/wu",
    component: () => import("./nuxt_assets/wu-EH0tGIL4.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./nuxt_assets/error-404-C2LwG33O.js"));
    const _Error = defineAsyncComponent(() => import("./nuxt_assets/error-500-DhSkfLmW.js"));
